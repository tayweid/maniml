...
from manim.renderer.opengl.mobject.svg.svg_mobject import SVGMobject as GLSVGMobject
from manim.renderer.opengl.mobject.types.image_mobject import ImageMobject as GLImageMobject
import warnings
