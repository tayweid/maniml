...
from manim.constants import FRAME_HEIGHT, FRAME_WIDTH
from manim.constants import DOWN, LEFT, ORIGIN, RIGHT, UP
from manim.constants import MED_LARGE_BUFF, MED_SMALL_BUFF, SMALL_BUFF
from manim.constants import BLACK, BLUE, GREEN, GREY_A, GREY_C, RED, WHITE, DEFAULT_MOBJECT_COLOR
...
from manim.utils.space_ops import get_closest_point_on_line
