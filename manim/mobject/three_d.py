...
import warnings
import numpy as np
from manim.renderer.opengl.constants import TAU, PI, OUT, UP, RIGHT, ORIGIN

# Import 3D objects from ManimGL's correct location
try:
    from manim.renderer.opengl.mobject.three_dimensions import (
        Sphere as GLSphere,
        Cube as GLCube, 
    ...
    from manim.renderer.opengl.mobject.coordinate_systems import ThreeDAxes
