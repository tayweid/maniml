...
from manim.renderer.opengl.constants import COLORMAP_3B1B
from manim.renderer.opengl.constants import WHITE
...
if TYPE_CHECKING:
    ...
    from manim.renderer.opengl.typing import ManimColor, Vect3, Vect4, Vect3Array, Vect4Array, NDArray
