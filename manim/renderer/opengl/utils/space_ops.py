...
from manim.renderer.opengl.constants import DOWN, OUT, RIGHT, UP
...
if TYPE_CHECKING:
    ...
    from manim.renderer.opengl.typing import Vect2, Vect3, Vect4, VectN, Matrix3x3, Vect3Array, Vect2Array
