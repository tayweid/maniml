...
from manim.renderer.opengl.constants import DEG, RADIANS
from manim.renderer.opengl.constants import FRAME_SHAPE
from manim.renderer.opengl.constants import DOWN, LEFT, ORIGIN, OUT, RIGHT, UP
