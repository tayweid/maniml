...
def initialize_manim_config() -> Dict:
    ...
    """
    args = parse_cli()
    global_defaults_file = os.path.join(get_manim_dir(), "default_config.yml")
...
def get_manim_dir():
    # For standalone maniml, use the opengl directory
    opengl_module = importlib.import_module("manim.renderer.opengl")
    opengl_dir = os.path.dirname(inspect.getabsfile(opengl_module))
    return opengl_dir
