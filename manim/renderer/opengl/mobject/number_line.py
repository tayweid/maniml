...
from manim.renderer.opengl.constants import DOWN, LEFT, RIGHT, UP
from manim.renderer.opengl.constants import DEFAULT_LIGHT_COLOR
...
if TYPE_CHECKING:
    ...
    from manim.renderer.opengl.typing import ManimColor, Vect3, Vect3Array, VectN, RangeSpecifier
