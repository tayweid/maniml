...
from manim.renderer.opengl.constants import BLUE, BLUE_D, BLUE_E, GREY_A, BLACK
from manim.renderer.opengl.constants import IN, ORIGIN, OUT, RIGHT
from manim.renderer.opengl.constants import PI, TAU
from manim.renderer.opengl.mobject.mobject import Mobject
from manim.renderer.opengl.mobject.types.surface import SGroup
from manim.renderer.opengl.mobject.types.surface import Surface
...
from manim.renderer.opengl.mobject.geometry import Polygon
...
if TYPE_CHECKING:
    ...
    from manim.renderer.opengl.typing import ManimColor, Vect3, Sequence
