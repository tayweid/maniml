...
from manim.renderer.opengl.constants import BLACK, RED, YELLOW, DEFAULT_MOBJECT_COLOR
from manim.renderer.opengl.constants import DL, DOWN, DR, LEFT, RIGHT, UL, UR
...
if TYPE_CHECKING:
    ...
    from manim.renderer.opengl.typing import ManimColor, Self
