...
from manim.renderer.opengl.utils.rate_functions import linear
from manim.renderer.opengl.utils.rate_functions import double_smooth
...
if TYPE_CHECKING:
    ...
    from manim.renderer.opengl.scene.scene import Scene
