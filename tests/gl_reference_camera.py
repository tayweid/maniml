"""Frozen pre-cutover OpenGL camera, used only as an independent test oracle."""
...
from tests.gl_reference_shader_wrapper import ShaderWrapper, VShaderWrapper
import numpy as np
...
class Camera(object):
    ...
    def release(self) -> None:
        for _, wrapper in self._wrappers.values():
            wrapper.release()
