...
from maniml.constants import DEFAULT_MOBJECT_TO_EDGE_BUFF
from maniml.constants import DEFAULT_MOBJECT_TO_MOBJECT_BUFF
from maniml.constants import DOWN, IN, LEFT, ORIGIN, OUT, RIGHT, UP
from maniml.constants import FRAME_X_RADIUS, FRAME_Y_RADIUS
from maniml.constants import MED_SMALL_BUFF
...
from maniml.utils.shaders import get_colormap_code
...
class _AnimationBuilder:
    ...
    def build(self):
        from maniml.animation.transform import _MethodAnimation
