...
from maniml.constants import DOWN, LEFT, RIGHT, UP
from maniml.constants import DEFAULT_LIGHT_COLOR
...
if TYPE_CHECKING:
    ...
    from maniml.typing import ManimColor, Vect3, Vect3Array, VectN, RangeSpecifier
