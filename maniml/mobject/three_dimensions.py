...
from maniml.constants import BLUE, BLUE_D, BLUE_E, GREY_A, BLACK
from maniml.constants import IN, ORIGIN, OUT, RIGHT
from maniml.constants import PI, TAU
from maniml.mobject.mobject import Mobject
from maniml.mobject.types.surface import SGroup
...
from maniml.mobject.geometry import Squircle
...
if TYPE_CHECKING:
    ...
    from maniml.typing import ManimColor, Vect3, Sequence
