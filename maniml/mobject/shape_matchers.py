...
from maniml.constants import BLACK, RED, YELLOW, DEFAULT_MOBJECT_COLOR
from maniml.constants import DL, DOWN, DR, LEFT, RIGHT, UL, UR
...
if TYPE_CHECKING:
    ...
    from maniml.typing import ManimColor, Self
