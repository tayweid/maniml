...
from maniml.constants import DEFAULT_PIXEL_WIDTH, FRAME_WIDTH
from maniml.constants import NORMAL
...
from maniml.utils.color import color_to_hex
from maniml.utils.color import int_to_hex
...
if TYPE_CHECKING:
    ...
    from maniml.typing import ManimColor, Span, Selector
...
class Text(MarkupText):
    """Plain text class that handles escaping of special characters."""
