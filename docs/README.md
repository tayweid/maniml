...
| [phase_b2_plan.md](phase_b2_plan.md) | B2: surfaces as biquadratic Bézier nets, the CPU grid for the reference renderers, the GPU evaluation behind `MANIML_SURFACE=nets`, and the measured results. Browser mirror pending. |
