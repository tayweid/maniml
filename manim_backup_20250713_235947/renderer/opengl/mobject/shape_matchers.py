...
from manim.constants import BLACK, RED, YELLOW, DEFAULT_MOBJECT_COLOR
from manim.constants import DL, DOWN, DR, LEFT, RIGHT, UL, UR
...
if TYPE_CHECKING:
    ...
    from manim.typing import ManimColor, Self
