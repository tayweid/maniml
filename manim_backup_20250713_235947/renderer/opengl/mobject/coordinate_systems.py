...
from manim.constants import BLACK, BLUE, BLUE_D, BLUE_E, GREEN, GREY_A, RED, DEFAULT_MOBJECT_COLOR
from manim.constants import DEG, PI
from manim.constants import DL, UL, DOWN, DR, LEFT, ORIGIN, OUT, RIGHT, UP
from manim.constants import FRAME_X_RADIUS, FRAME_Y_RADIUS
from manim.constants import MED_SMALL_BUFF, SMALL_BUFF
from manim.mobject.functions import ParametricCurve
...
if TYPE_CHECKING:
    ...
    from manim.typing import ManimColor, Vect3, Vect3Array, VectN, RangeSpecifier, Self
