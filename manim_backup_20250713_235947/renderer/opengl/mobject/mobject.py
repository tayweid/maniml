...
from manim.constants import DEFAULT_MOBJECT_TO_EDGE_BUFF
from manim.constants import DEFAULT_MOBJECT_TO_MOBJECT_BUFF
from manim.constants import DOWN, IN, LEFT, ORIGIN, OUT, RIGHT, UP
from manim.constants import FRAME_X_RADIUS, FRAME_Y_RADIUS
...
from manim.utils.iterables import arrays_match
from manim.utils.iterables import array_is_constant
...
from manim.utils.shaders import get_colormap_code
...
if TYPE_CHECKING:
    ...
    from manim.typing import ManimColor, Vect3, Vect4Array, Vect3Array, UniformDict, Self
